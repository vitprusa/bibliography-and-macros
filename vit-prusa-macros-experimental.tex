...
\newcommand{\deformationc}{\mathrm{\chi}}

\newcommand{\fgrad}{\tensorq{F}}
\newcommand{\fgradc}{\mathrm{F}}
...
\newcommand{\ienergy}{\ensuremath{e}} % internal energy
...
\newcommand{\tenergy}{\ensuremath{E}} % total energy

% Energy flux, heat flux
\newcommand{\efluxc}{\vec{q}_{e}} % energy flux, current configuration
\newcommand{\hfluxc}{\vec{q}}     % heat flux, current configuration
\newcommand{\eflux}{\vec{Q}_{e}} % energy flux, reference configuration
\newcommand{\hflux}{\vec{Q}}     % heat flux, reference configuration

% Energy source
\newcommand{\esourcec}{\ensuremath{q}} % energy source, current configuration
