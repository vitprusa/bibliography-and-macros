...
\DeclareMathOperator{\bregmandivergence}{D} % Bregman divergence
\DeclareMathOperator{\principalvalue}{p.v.} % Cauchy principal value
...
\newcommand{\foidentity}{\ensuremath{\mathcal{I}}} % fourth order identity tensor
...
% Sometimes it also helps to switch of the bm package.
...
% logarithmic spin
\newcommand{\logspin}{\genspin[\mathrm{log}]}
\newcommand{\genspin}[1][\star]{\ensuremath{\tensorq{\Omega}}^{#1}}
...
% Wave speed
\newcommand{\cdiscrete}{c_{\text{D}}}
\newcommand{\ccontinuous}{c_{\text{C}}}
...
% Purely thermal and mechanical parts
\newcommand{\thermp}{{\mathrm{therm}}}
\newcommand{\mechp}{{\mathrm{mech}}}
...
\newcommand{\volienergy}{\overline{\ienergy}} % specific internal energy (energy per unit volume)
...
\newcommand{\volentropy}{\overline{\entropy}} % specific entropy (entropy per unit volume)
...
% Classical entropy, classical energy, classical volume -- for use in calculations in classical thermodynamics
\newcommand{\ctentropy}{S}
\newcommand{\ctenergy}{U}
\newcommand{\ctvolume}{V}
\newcommand{\cttemperature}{T}
\newcommand{\ctpressure}{P}
\newcommand{\cthelmholtz}{F}
\newcommand{\ctgibbs}{G}
\newcommand{\ctenthalpy}{H}
...
% Generic corrotational derivative
\newcommand{\gencofid}[1]{\ensuremath{\accentset{\medcircle_{\star}}{#1}}}
\newcommand{\gencofidd}[1]{\ensuremath{\accentset{\medcircle_{\star} \! \medcircle _{\star}}{#1}}}
...
% Bregman divergence as operator
\newcommand{\bregmandivergenceop}[3]{\bregmandivergence_{#1} \left(\left.\! #2 \right\| \! #3 \right)}
