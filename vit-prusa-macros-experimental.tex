...
\newcommand{\displacementc}{\mathrm{U}}
...
\newcommand{\enthalpy}{\ensuremath{h}} % specific enthalpy
...
\newcommand{\tenergy}{\ensuremath{e_{\mathrm{tot}}}} % specific total energy (energy per unit mass), internal energy plus kinetic energy
...
\newcommand{\netienergy}{\ensuremath{E}} % net energy
